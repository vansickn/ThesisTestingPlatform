<template>
  <div
    ...
    class="container flex flex-col gap-10 bg-gray-200 justify-center items-center border-4 border-dashed border-red-500 md:w-640 md:h-360 sm:w-426 sm:h-240 xs:w-426 xs:h-240 mx-5 mb-5 "
  >
...
// .dropzone {
//   // need to figure out how to retain scale when the screen is resized for the dropzone, same actions as the img
